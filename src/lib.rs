...
turbo::go!({
    ...
    state
        .bullets_1
        .retain(|bullet| !bullets_to_remove_1.contains(bullet));
    ...
    state
        .bullets_2
        .retain(|bullet| !bullets_to_remove_2.contains(bullet));
    ...
    sprite!(
        "npc_bluey",
        x = (state.npc_blue_x - 16.0) as i32,
        y = (state.npc_blue_y - 16.0) as i32,
        fps = fps::FAST
    );
    sprite!(
        "npc_spex",
        x = (state.npc_spex_x - 16.0) as i32,
        y = (state.npc_spex_y - 16.0) as i32,
        fps = fps::FAST
    );
